# Generated by Django 3.2.15 on 2022-09-27 02:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playlist_image', cloudinary.models.CloudinaryField(default='placeholder', max_length=255, verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='playlist.playlist')),
            ],
            options={
                'ordering': ['created_on'],
            },
